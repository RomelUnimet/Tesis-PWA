                ...
                <div className="profile-container">
                    ...
                    >
                        <svg viewBox="0 0 32 42" fill="none" xmlns="http://www.w3.org/2000/svg"
                             style={userSettings[0].photo===""? {} : {display:'none'}}
                        >
                    ...
                    <div className="profile-data-container">
                        <h1>{userSettings[0].name!==""? userSettings[0].name : 'Diary Name' }</h1>
                        <h3>{userSettings[0].description!==""? userSettings[0].description : `Today's Talk`}</h3>
