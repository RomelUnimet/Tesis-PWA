...
export const CreateModal = ({CEModalState, setCEModalState}) => {
    ...
    const hasData = () => {
        ...
        return (entryImgState.length!==0 || title!=='' || text!=='' || selectedWeather!=='none' || tagsCE.length!==0 || locationCE!=='');
            ...
            <AnimatePresence>
                {
                    ...
                    <ConfirmModal
                        title={'Wait!'}
                        text={'There is content being written.'}
                        ...
                        isActive={confirmModalState}
                        setIsActive={setconfirmModalState}       
                    />
                }
            </AnimatePresence>
