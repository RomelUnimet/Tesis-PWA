...
export const EntrySaveAsImg = ({entry, saveAsImgModal, setSaveAsImgModal}) => {
    ...
    const transition = useTransition(saveAsImgModal, {
    ...
    useEffect(() => {
        ...
        */
        ...
        //SE HACE UN WEB SHARE CON LA API
        //DE LA IMAGEN QUE SE AGARRA DEL DIV
    }, [])
    ...
    return (
        ...
        {transition((style, item) => 
            item?
            <animated.div className="detailed-entry-container-save-img"
                style={style}
