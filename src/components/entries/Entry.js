                    ...
                    <div className="entry-tag-loc-container" >
                        { tags.length!==0 &&
                            <div className="entry-tag-loc-label">
                                <svg className='tag-loc-svg' viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        { location!=='' &&
                            <div className="entry-tag-loc-label">
                                <svg className='tag-loc-svg' viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
