...
import { ImgCarrousel } from '../create_entry/ImgCarrousel';

import { useDispatch, useSelector } from 'react-redux';

import { animated, useTransition } from 'react-spring'
import { entryUpdate } from '../../actions/entry';
...
export const EditEntryModal = ({EditModalState, setEditModalState, entry}) => {
    ...
    const handleEditEntry = () => {
        ...
        dispatch( entryUpdate( entry, newEntry ) )
        closeModal()
    ...
    const transition = useTransition(EditModalState, {
